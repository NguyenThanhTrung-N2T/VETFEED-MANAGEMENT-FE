...
type Props = {
    isOpen: boolean;
    onClose: () => void;
    onApply: (filters: KhachHangFilterValues) => void;
    onReset: () => void;
    initialFilters?: KhachHangFilterValues;
};

export default function FilterKhachHangModal({
    isOpen,
    onClose,
    onApply,
    onReset,
        ...
        <Modal size="md">
            <div className="flex flex-col h-full">
                ...
                <div className="flex flex-col items-center justify-center pt-2 mb-6">
                    ...
                    <h2 className="text-xl font-bold text-slate-800">Lọc khách hàng</h2>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="relative">
                                <select
                                    name="loaiKhachHang"
                                    value={filters.loaiKhachHang || "ALL"}
