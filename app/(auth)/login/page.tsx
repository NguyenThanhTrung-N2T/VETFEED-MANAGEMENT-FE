      ...
      <div className="bg-[#fdfbf7] w-full max-w-4xl min-h-[550px] rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row relative">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center z-10">
          <div className="text-center md:text-left mb-8">
            <h2 className="text-3xl font-bold text-slate-800 font-serif tracking-wide mb-6 text-center">
              ĐĂNG NHẬP
            </h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 text-slate-500">
            <div className="space-y-1">
              <label className="block text-sm font-semibold text-slate-600 pl-1 font-serif">
                Email
              </label>
              <input
                required
            ...
            <div className="flex justify-center md:justify-end">
              <Link
                ...
                className="text-sm font-bold text-slate-800 italic hover:underline font-serif"
              >
                Quên mật khẩu ?
              </Link>
            </div>
